...
public class DebugEntry : MonoBehaviour
{
    ...
    public Dictionary<DebugDataType, DebugData> AllDebugData = new();
    ...
    public void UpdateDebugEntry(List<DebugData_Data> allDebugData)
    {
        ...
        {
            if (!AllDebugData.ContainsKey(debugData.DebugDataType))
            {
                var newDebugData = Instantiate(Debug_Visualiser.Instance.DebugDataPrefab, AllData).AddComponent<DebugData>();
                newDebugData.InitialiseDebugData(new DebugData_Data(debugData));
                AllDebugData.Add(debugData.DebugDataType, newDebugData);
                return;
            }

            AllDebugData[debugData.DebugDataType].DebugValue = debugData.DebugValue;
        }
    }
}
...
{
    public string DebugEntryName;
    public string DebugEntryObject;
    public uint DebugEntryID;
...
{
    public DebugEntryKey DebugEntryKey;
    public List<DebugData_Data> AllDebugData;
