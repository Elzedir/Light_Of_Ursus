...
namespace City
{
    ...
    [Serializable]
    public class AllCities_SO : Base_SO<City_Component>
    {
        public List<City_Data> AllCityData;

        public void SetAllCityData(List<City_Data> allCityData)
        {
    ...
    public class AllCities_SOEditor : Editor
    {
        ...
        private void DrawCityAdditionalData(City_Data selectedCityData)
        {
