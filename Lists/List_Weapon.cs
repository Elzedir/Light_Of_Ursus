...
public class List_Weapon : Manager_Item
{
    ...
    static void _shortBows()
    {
        ...
        AddToList(new Item_Master(commonStats_Item: commonStats_Item, visualStats_Item: visualStats, weaponStats_Item: weaponStats, null, fixedModifiers_Item: fixedModifiers, percentageModifiers_Item: percentageModifiers, null));
    }
