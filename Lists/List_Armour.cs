...
public class List_Armour : Manager_Item
{
    ...
    static void Heavy()
    {
        ...
        AddToList(new Item(commonStats_Item: commonStats_Item, null, null, armourStats_Item: armourStats, fixedModifiers_Item: fixedModifiers, percentageModifiers_Item: percentageModifiers));
    }
}
