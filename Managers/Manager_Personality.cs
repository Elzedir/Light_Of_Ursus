...
namespace Managers
{
    ...
    public abstract class Manager_Personality
    {
        ...
        {
            return PersonalityRelations.GetValueOrDefault(a < b ? (a, b) : (b, a), 0);
        }
    ...
    public enum PersonalityTraitName { Arrogant, Ambitious, Brave, Craven, Deceitful, Honest, Humble, Just, Impatient, Patient, Sadistic, Savage, Vengeful }
    ...
    public class PersonalityComponent : ComponentReference_Actor
    {
        ...
        {
            (_personalityTitle, _personalityDescription) = Manager_Personality.GetPersonalityTitleAndDescription(this);

            //Debug.Log(ActorID);

            Actor.ActorData.SpeciesAndPersonality.ActorPersonality.SetPersonalityTitle(_personalityTitle, _personalityDescription);
        }
        ...
        {
            if (PersonalityTraits.All(t => t.TraitName != traitName)) PersonalityTraits.Add(Manager_Personality.GetTrait(traitName));
    ...
    public class PersonalityTrait
    {
        ...
        public List<Effect> TraitEffects;
